...
# ============================================================================
# ALL ENDPOINTS MOVED TO MODULAR ROUTE FILES
# ============================================================================
# - Authentication: routes/auth_routes.py
# - Activities: routes/activity_routes.py
# - Customers: routes/customer_routes.py
# - Locations: routes/location_routes.py
# - Products: routes/product_routes.py
# - Leads: routes/lead_routes.py
# - Companies: routes/company_routes.py
# - Users: routes/user_routes.py
# - Teams: routes/team_routes.py
# - Geofences: routes/geofence_routes.py
# - Dashboard: routes/dashboard_routes.py
# ============================================================================

# ============================================================================
# WEBSOCKET ENDPOINT (Keep here as it uses manager)
# ============================================================================
...
# ============================================================================
# LOCATION ENDPOINTS - Moved to routes/location_routes.py
# ============================================================================
...
# ============================================================================
# PRODUCTS ENDPOINTS - Moved to routes/product_routes.py
# ============================================================================

# ============================================================================
# LEADS (SALES FEATURE) - Moved to routes/lead_routes.py
# ============================================================================

# ============================================================================
# COMPANY ENDPOINTS - Moved to routes/company_routes.py
# ============================================================================
...
@api_router.get("/companies/current/settings", response_model=Company)
