        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              {/* Activities Value */}
              <Card className="hover:shadow-lg transition-shadow" data-testid="stat-activities-value">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Activities Value</p>
                      <h3 className="text-3xl font-bold mt-2 text-green-600">
                        {formatAmount(stats?.total_activities_value || 0)}
                      </h3>
