      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow mb-6 p-6">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-green-500 text-white px-6 py-2 rounded-lg hover:from-orange-600 hover:to-sky-600"
            >
              + Add New Company
            </button>
          </div>
        ...
        {(selectedCompany || isEditing) && (
          <div className="bg-white rounded-lg shadow">
            <div className="bg-gradient-to-r from-blue-500 to-green-500 px-6 py-4 rounded-t-lg">
              ...
              <div className="flex gap-3 justify-end mt-6 pt-6 border-t">
                {selectedCompany && !isEditing ? (
                  <button
                    ...
                    className="px-6 py-2 bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-lg hover:from-orange-600 hover:to-sky-600"
                  >
                    ✏️ Edit Settings
                  </button>
                ) : (
                  <>
                    ...
                    <button
                      type="submit"
                      disabled={saving}
                      className="px-6 py-2 bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-lg hover:from-orange-600 hover:to-sky-600 disabled:opacity-50"
                    >
